  ...
  return (
    <div className="category-container">
      <Link className="category" to={'/category/socks'}>
        <div className="category__image-socks" title="ponožky"></div>
      ...
      <Link className="category" to={'/category/stockings'}>
        <div className="category__image-stockings" title="punčošky"></div>
      ...
      <Link className="category" to={'/category/adults'}>
        <div className="category__image-adults" title="pro dospělé"></div>
